...
import { serviceUploadImage } from "../../services/uploadImage";
import { serviceRemoveBg } from "../../services/removeBg";
...
import ShareFacebookBtn from "./ShareFacebookBtn/ShareFacebookBtn";
import CrtFrameCropperCapture from "./CrtFrameCropperCapture/CrtFrameCropperCapture";
import UploadImageAgainBtn from "./UploadImageAgainBtn/UploadImageAgainBtn";
import UploadImageBtn from "./UploadImageBtn/UploadImageBtn";
import NextStep3Btn from "./NextStep3Btn/NextStep3Btn";
    ...
    <section className="crt-frame">
      ...
      <div className="crt-frame-ct">
        <img
          ...
          src="/assets/svg/logo-title-3.svg"
          alt=""
        />
        <div className="crt-frame-process">
